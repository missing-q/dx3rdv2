...
export class DX3rdItemSheet extends api.HandlebarsApplicationMixin(
  ...
  static PARTS = {
    header: {
      template: 'systems/dx3rd/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/dx3rd/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
        'systems/dx3rd/templates/item/attribute-parts/feature.hbs',
    },
    attributesGear: {
      template: 'systems/dx3rd/templates/item/attribute-parts/gear.hbs',
    },
    attributesSpell: {
      template: 'systems/dx3rd/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/dx3rd/templates/item/effects.hbs',
    },
  };
  ...
  async _prepareContext(options) {
    const context = {
      ...
      // Adding a pointer to CONFIG.DX3RD
      config: CONFIG.DX3RD,
